...
class CurveBall(Optimizer):
	...
	def __init__(self, params, lr=1e-3, momentum=0.9, auto_lambda=True, lambd=10.0,
		...
		"""
			...
			params - model params 
			lr - learning rate - is it the beta from the paper ?
			momentum - the rho value (don't need to input it)
	...
	def step(self, model_fn, loss_fn):
		...
		predictions = model_fn() # this is the forward func
		...
		# we don't need to change this for other implementations
